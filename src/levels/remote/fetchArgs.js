      ...
      "childViews": [
        {
          ...
          "options": {
            "markdowns": [
              "## Аргументи git fetch",
              "",
              "Отже, ми вже вивчили все про аргументи git push, про корисний параметр `<place>` і про формат запису з двокрапкою (`<source>:<destination>`). Чи знадобляться нам ці знання при вивченні `git fetch`?",
              "",
        ...
        },
        {
          ...
          "options": {
            "markdowns": [
              ...
              "",
              "Насправді, розробники рідко використовують такий спосіб на практиці. І він показаний тут лише для повноти опису -- наскільки `fetch` і `push` схожі, і відрізняються лише напрямом дії."
            ]
          }
        },
        {
